# Design System — Lumina SaaS Landing Page

> Category: Landing Pages  ·  Industry: SaaS
> Auto-scaffolded from prompt [`lumina-saas-landing-page`](../../prompts/lumina-saas-landing-page/). Fields marked
...
- **Neo-Brutalist Push Button** — A high-contrast button that visually 'depresses' when hovered or clicked.
- **Browser Mockup Dashboard** — A stylized application UI container for marketing visuals.

## 7. Motion

REVIEW —
- Micro-interactions involve 'translate' effects on hover where buttons move 4px to 'fill' their shadow space
