...
- **Property Inspector Grid** — High-density data entry UI
- **Simulated Selection Box** — Visual indicator for 'Inspecting' elements

## 7. Motion

REVIEW —
- 4s slide-ups and ease-in-out cursor simulations
- All interactive elements should use #06B6D4 for active states and hover outlines
