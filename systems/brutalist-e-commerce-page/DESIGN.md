# Design System — Brutalist E-commerce Page

> Category: E-commerce  ·  Industry: E-commerce & Retail
> Auto-scaffolded from prompt [`brutalist-e-commerce-page`](../../prompts/brutalist-e-commerce-page/). Fields marked
...
- **Interactive CTA Button** — A high-contrast button with a directional fill animation.
- **Animated Gradient Blobs** — Soft organic shapes that provide depth behind text.
