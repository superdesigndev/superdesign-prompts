...
REVIEW —
- Single teal accent ramp: teal-300 #5eead4 (hover/links), teal-400 #2dd4bf (primary CTA, icons, hairline), teal-500 #14b8a6 (deep)
- Accent treatment is restrained: teal used only for the submit button fill (#2dd4bf bg, #080a0a text), the top hairline gradient, small leading icons, a focus glow ring, and link hover
