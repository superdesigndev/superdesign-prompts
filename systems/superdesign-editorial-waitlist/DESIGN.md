# Design System — Superdesign Editorial Waitlist

> Category: Waitlist & Coming Soon  ·  Industry: General
> Auto-scaffolded from prompt [`superdesign-editorial-waitlist`](../../prompts/superdesign-editorial-waitlist/). Fields marked
...
- **Effects**:
  ...
  - **Borders**: 1px solid borders using `#66473B` or `#3521 …
...
- **Rotating Waitlist Badge** — An animated circular badge indicating current status.
- **Cinematic Text Layering** — A depth-effect headline style using outlines.
