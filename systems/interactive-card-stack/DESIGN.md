# Design System — Interactive Card Stack

> Category: Components  ·  Industry: General
> Auto-scaffolded from prompt [`interactive-card-stack`](../../prompts/interactive-card-stack/). Fields marked
...
- `Reset Animation`
- `Premium interactive card stack with drag physics and autoplay`
