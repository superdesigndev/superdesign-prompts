# Design System — Bold Editorial Style

> Category: Waitlist & Coming Soon  ·  Industry: SaaS
> Auto-scaffolded from prompt [`bold-editorial-style`](../../prompts/bold-editorial-style/). Fields marked
...
- **Abstract UI Mockup** — A browser-style mockup frame used to showcase software interface without high-fidelity images.
- **Testimonial High-Contrast Cards** — Alternating light and dark review cards with oversized star icons.
