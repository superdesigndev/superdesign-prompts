# Design System — Bottom Tab Navigation — Core App Shell

> Category: Mobile Apps  ·  Industry: General
> Auto-scaffolded from prompt [`bottom-tab-navigation-core-app-shell`](../../prompts/bottom-tab-navigation-core-app-shell/). Fields marked
