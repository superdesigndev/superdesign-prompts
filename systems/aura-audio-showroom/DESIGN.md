...
A vertical narrative layout designed as a 'walk-through' showroom experience, starting with atmospheric brand-building and moving toward technical specifications and final purchase reassurance.

## 6. Components

- **Tactile Model Cards** — Interactive cards that act as the primary configuration tool for the page.
- **Material Highlight Badge** — Small floating informational cards describing physical materials.

## 7. Motion

REVIEW —
- 8s ease-out) and soft hover scales (1
- 2, 1) for card hover transitions
