...
- **Status Badge** — A minimalist indicator for system status.
- **Network Topology Graph** — An abstract SVG visualization of a design system network.
- **Monospaced Testimonial Card** — Flat testimonial card with technical metadata.

## 7. Motion

REVIEW —
- Micro-interactions are snappy with linear or standard ease-out curves
- Images should use 'mix-blend-luminosity' with a 90% opacity and shift to full color on hover
