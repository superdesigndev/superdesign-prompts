# Design System — Questions, Set in Serif — An Editorial FAQ

> Category: Blog & Editorial  ·  Industry: General
> Auto-scaffolded from prompt [`questions-set-in-serif-an-editorial-faq`](../../prompts/questions-set-in-serif-an-editorial-faq/). Fields marked
...
REVIEW —
- The page background is a cream #faf6ef with slightly lighter paper #fffdf9 cards; ink #1c1815 is the near-black text and the inverted nav-band/footer fill; inksoft #5a534c is the muted body grey; a single wine #7b2d3b accent (deepening to winedeep #5e2029 on hover) carries every highlight: question numbers, the open question color, list icons, the 'Ask a human' / 'Talk to us' pills and link underlines
- Background cream #faf6ef; card surfaces paper #fffdf9; text ink #1c1815 with muted body inksoft #5a534c; one wine accent #7b2d3b deepening to winedeep #5e2029 on hover
- Keep it airy with large vertical rhythm; transitions ease on cubic-bezier(0
