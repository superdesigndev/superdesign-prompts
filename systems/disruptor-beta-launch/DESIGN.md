# Design System — Disruptor Beta Launch

> Category: Waitlist & Coming Soon  ·  Industry: General
> Auto-scaffolded from prompt [`disruptor-beta-launch`](../../prompts/disruptor-beta-launch/). Fields marked
...
- **Brutalist Countdown Timer** — A series of high-contrast boxes displaying time units.
- **Integrated Waitlist Form** — A high-precision input and button combination.

## 7. Motion

REVIEW —
- Buttons: Brutalist style with 4px borders, mono-spaced text, and hover states that translate 4px/4px to 'fill' the shadow gap
