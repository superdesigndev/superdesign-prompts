# Design System — Cart Drawer- Essential Slide in

> Category: E-commerce  ·  Industry: E-commerce & Retail
> Auto-scaffolded from prompt [`cart-drawer-essential-slide-in`](../../prompts/cart-drawer-essential-slide-in/). Fields marked
