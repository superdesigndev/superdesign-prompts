# Design System — Softly - Digital Wellness App

> Category: Waitlist & Coming Soon  ·  Industry: Health & Wellness
> Auto-scaffolded from prompt [`softly-digital-wellness-app`](../../prompts/softly-digital-wellness-app/). Fields marked
...
- **Interactive FAQ Accordion** — Smooth expanding/collapsing questions with icon rotation.
- **Grain Overlay** — A global texture layer that makes the flat design feel analog.

## 7. Motion

REVIEW —
- - **Animations**: Use 'reveal-on-scroll' (translateY: 30px to 0, opacity 0 to 1, duration 0
