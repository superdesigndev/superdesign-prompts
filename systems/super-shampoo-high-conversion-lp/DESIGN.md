# Design System — Super Shampoo - High Conversion LP

> Category: E-commerce  ·  Industry: E-commerce & Retail
> Auto-scaffolded from prompt [`super-shampoo-high-conversion-lp`](../../prompts/super-shampoo-high-conversion-lp/). Fields marked
...
- **Urgency Indicator Tag** — A small, high-contrast label used to drive FOMO.
- **Benefit Icon Cards** — Informational cards that change background color on hover.
- **Mobile Sticky Cart** — Fixed bottom bar for mobile conversion.

## 7. Motion

REVIEW —
- **Animations**: Implement smooth hover transforms (scale: 1
