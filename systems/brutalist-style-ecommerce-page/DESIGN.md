# Design System — Brutalist Style Ecommerce Page

> Category: E-commerce  ·  Industry: E-commerce & Retail
> Auto-scaffolded from prompt [`brutalist-style-ecommerce-page`](../../prompts/brutalist-style-ecommerce-page/). Fields marked
...
- **Neon Interaction Badge** — A sharp-edged, high-visibility utility badge for product status or quick actions.
- **Texture Overlay** — Full-screen SVG noise grain that unifies the brutalist aesthetic.
- **Split-Indented Headline** — A typography style for hero headers that utilizes large-scale indentation for visual tension.

## 7. Motion

REVIEW —
- Animations are swift and purposeful, including image scaling and neon-green hover states (#31EF07)
- Links should feature a custom hover animation using a 2px neon green underline that scales from 0 to 1 with cubic-bezier(0
- Images must be high-contrast, often grayscale, with a hover scale effect of 1
