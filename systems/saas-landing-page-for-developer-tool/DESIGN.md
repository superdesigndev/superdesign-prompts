# Design System — SaaS Landing Page for Developer Tool

> Category: Landing Pages  ·  Industry: Dev Tools
> Auto-scaffolded from prompt [`saas-landing-page-for-developer-tool`](../../prompts/saas-landing-page-for-developer-tool/). Fields marked
...
- **Poster Button** — A high-contrast, zero-radius rectangular button.
- **Typographic List Item** — Large interactive list items with a sidebar index.
- **Grid Sidebar Label** — Sticky section labels used to navigate the grid.
