...
- **Side-by-Side Narrative Cards** — A split-screen storytelling component that uses contrasting backgrounds to highlight differences.
- **Truth Matrix** — A list-based comparison that uses plus and minus symbols for unbiased assessments.

## 7. Motion

REVIEW —
- - **Hover States:** Smooth color transitions (300ms cubic-bezier(0
- - **Interactions:** Subtle X-axis translation (2-4px) on hover for interactive scenario cards
