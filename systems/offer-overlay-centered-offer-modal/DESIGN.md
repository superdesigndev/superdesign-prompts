# Design System — Offer overlay- Centered Offer Modal

> Category: E-commerce  ·  Industry: E-commerce & Retail
> Auto-scaffolded from prompt [`offer-overlay-centered-offer-modal`](../../prompts/offer-overlay-centered-offer-modal/). Fields marked
...
- class="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gray-900 hover:bg-black text-white text-sm font-medium rounded-lg shadow-lg shadow-gray-900/10 transition-all active:scale-[0
