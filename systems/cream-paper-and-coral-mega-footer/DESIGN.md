...
REVIEW —
- Accent is a warm coral #F0552B with a darker hover #D6431D, a deep rust #9A2F0D for links/eyebrows, and a pale coral wash #FCE2D6 for chips and icon tiles
- Accent treatment: a 3px coral-to-peach-to-coral gradient hairline pinned to the top edge of the band, pale-coral pill chips, rust text links that underline on hover, and a coral focus ring (2px #F0552B, 2px offset)
