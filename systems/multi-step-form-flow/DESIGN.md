# Design System — Multi-step Form Flow

> Category: Onboarding  ·  Industry: General
> Auto-scaffolded from prompt [`multi-step-form-flow`](../../prompts/multi-step-form-flow/). Fields marked
