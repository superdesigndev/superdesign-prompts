# Design System — Gen-Z Social App

> Category: Waitlist & Coming Soon  ·  Industry: General
> Auto-scaffolded from prompt [`gen-z-social-app`](../../prompts/gen-z-social-app/). Fields marked
...
- **Floating Sticker System** — Decorative icons or emojis that appear 'stuck' onto the interface.
- **Brutalist Phone Mockup** — An in-app UI preview inside a stylized phone frame.
- **Wobble Button** — A button that shakes when hovered to grab attention.

## 7. Motion

REVIEW —
- Interaction: Every button and card must use a bouncy scale transition (cubic-bezier(0
