...
A reusable Auth & Login generator. Bring a design system (colors, type, motion) and this
skill supplies the structure — sections, layout, and the components users expect.

## Common sections

- Sticky nav  _(in 3 prompts)_
- Footer  _(in 3 prompts)_
- Trust strip  _(in 2 prompts)_
- Responsive reflow  _(in 2 prompts)_
- Left form column  _(in 2 prompts)_
- Sticky nav (full-bleed)  _(in 2 prompts)_
- Social auth row  _(in 2 prompts)_
- Divider  _(in 2 prompts)_
- Sticky glass nav  _(in 2 prompts)_
- Eyebrow + heading  _(in 2 prompts)_
- Hero / sign-in grid  _(in 1 prompts)_
- Left pitch column  _(in 1 prompts)_
...
```text
Build a Auth & Login using the "<system-id>" design system
